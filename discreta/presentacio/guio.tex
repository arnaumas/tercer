...
\begin{itemize}
	...
	\item Definició de distribució estacionària. Prova de l'existència i unicitat de distribucions estacionàries per a qualsevol graf. Prova de la convergència a la distribució estacionària de qualsevol passeig aleatori en un graf no bipartit. 
	\item	Introducció a l'algorisme PageRank com un problema de passejos aleatoris en grafs. Probabilitats de teletransportació. PageRank personalitzat.
