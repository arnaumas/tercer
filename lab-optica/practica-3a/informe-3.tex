...
\begin{figure}[htb]
	...
	% Pupil·la de sortida
	\draw[|-, densely dashed, thick, opacity = 0.7, color = olive] (\xoc - \xso, 0) ++ (0,\yso) -- +(0,0.5);
	\draw[|-, densely dashed, thick, opacity = 0.7, color = olive] (\xoc - \xso, 0) [yscale = -1] ++ (0,\yso) -- +(0,0.5) node[below, olive, opacity = 1] {PS};
