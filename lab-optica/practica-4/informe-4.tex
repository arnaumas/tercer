...
\node[above] at (6,1) {Ocular};
		...
		\end{scope}
	\end{tikzpicture}
	\caption{Esquema de la disposición del espectrómetro. El sistema óptico onjetivo-ocular tiene un efecto magnificador que no se muestra en la figura.}	
	\label{fig:esquema}
\end{figure}
...
\begin{figure}[htb]
	...
	\begin{tikzpicture}
		...
		\draw[raig, name path = raig1] (0,0) -- (entrada1);
		\draw[raig, color = green] (entrada1) -- (sortida1) [shift = {(sortida1)}, rotate = -15] -- (4,0) coordinate (obj) -- ++(2,0) coordinate (ocu) -- ++(1,0);
		...
		\path[name path = raig33] (sortida3) [shift = {(sortida3)}, rotate = -19] -- (7,0);
		...
		\draw[raig, color = red] (entrada1) -- (sortida2) -- (obj2) -- (ocu2) [shift = {(ocu2)}, rotate = -14] -- (1,0);
		\draw[raig, color = blue] (entrada1) -- (sortida3) -- (obj3) -- (ocu3) [shift = {(ocu3)}, rotate = -16] -- (1,0);

		\draw[raig, color = green, dashed] [shift = {(ocu)}, rotate = -15] (-8,0) -- (ocu);
		\draw[raig, color = red, dashed] [shift = {(ocu2)}, rotate = -14] (-8,0) -- (ocu2);
		\draw[raig, color = blue, dashed] [shift = {(ocu3)}, rotate = -16] (-8,0) -- (ocu3);
